...
{
    destroyShaders();
    QString vertexShaderFile (":/shaders/vmodel.glsl");
    QString fragmentShaderFile (":/shaders/fmodel.glsl");
...
void Model::drawModel()
{
    ...
    glUniformMatrix4fv(locTargetMatrix, 1, GL_FALSE, modelMatrix.data());
...
void Model::readOFFFile (QString const & offFile)
{
    ...
    fileName =  tempDir.absoluteFilePath(offFile);
